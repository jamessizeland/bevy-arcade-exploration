...
export function wasm_bindgen__convert__closures__invoke0_mut__h05b65cd1c9bd9675(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h107c4eb60b54551b(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h277d540c26c36fcc(a: number, b: number, c: number, d: number): void;
